...
def predict_from_file(
    ...
    Args:
        ...
        target_column: Nom de la colonne cible à exclure des features
    Returns:
    ...
    # Séparer les features de la cible si elle existe
    y_true = None
    if target_column in df.columns:
        logger.info(f"Suppression de la colonne cible '{target_column}' des features")
    ...
    # Inclure la vérité terrain si disponible
    if y_true is not None:
...
def main(
    ...
    predictions_output: Path = MODELS_DIR / "predictions/test_predictions.csv",
    include_probabilities: bool = True,
    save_features: bool = False,
    target_column: str = "Heart Disease",
):
